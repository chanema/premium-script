...
FaviconURL		= 'https://dl.dropboxusercontent.com/s/h7ddtdyu5i1f88b/derp16.png';

ChannelName		= 'Chanema';

MiniLogoURL		= 'https://dl.dropboxusercontent.com/s/b86oncddkedda07/derpao%20cabeca.png';
...
CustomFooterHTML	= 'Não recebemos nenhuma ordem judicial secreta e não estamos sob qualquer ordem de silêncio. (15/05/20)';

AnswersArray		= [
	'Sim', 'Não', 'Pergunte outra vez', 'Só de vez em quando', 'Só se não chover', 'Não vou responder por enquanto', '50%', 'Não sei', 'Às vezes sim, às vezes não', 'Ah, não precisava nem perguntar, você já sabe a resposta .perdi', 'Arrume seu quarto primeiro, depois eu respondo .jordan', 'E o seu quarto, já arrumou? .jordan2', 'E a pia cheia de pratos? .jordan3','Provavelmente' , 'E eu com isso?', '100% garantido','Você só descobrirá quando sair de casa', 'Você está perto de descrobrir isso sozinho','Então, meu patrão','Xiiiii', 'Se você soubesse a verdade, ficaria enojado', 'A verdade é que **THEGAME**' , 'Tô nem aí .dan3', 'Pode ser', 'Mais tarde respondo', '!rapaz .rapaz2' , 'Quer mesmo saber? .pepe8', 'E se a resposta custasse tudo o que você acredita? .redpill3', 'Mais ou menos'
];
...
'!brio':'https://www.myinstants.com/media/sounds/voce-tem-brio.mp3',
...
'!porra':'https://www.myinstants.com/media/sounds/porra-meu-ala.mp3',
...
'!wilhelm': 'https://www.myinstants.com/media/sounds/wilhelmscream_1.mp3',
'!lasier' : 'https://www.myinstants.com/media/sounds/lasier-martins-tomando-choque_1.mp3',
'!perfect' : 'https://www.myinstants.com/media/sounds/perfect-street-fighter-sound-effect.mp3',
'!moedinha' : 'https://www.myinstants.com/media/sounds/mario-coin-sfx.mp3',
...
'!quebom' : 'https://www.myinstants.com/media/sounds/panico-que-bom.mp3',
...
'!ihuu' : 'https://www.dropbox.com/s/7p95vpm7dyizpzh/IHUU.mp3?dl=1', 
...
['https://www.youtube.com/watch?v=fSKNRgxoeYc', 'Jesus do SBT'],
...
['https://drive.google.com/open?id=17k5aYTrOwFYM8emnOWBzHnXStrrxZnMD', 'Patrocinadores'],
